LOGFILE=$LOGDIR/det_merge_deblend_thresh_noreg_meas_withscarlet_noprop_maxiter_defaultrefcat_inputdir_outputdir-DRP.log; \
date | tee $LOGFILE; \
pipetask --long-log --log-file $LOGFILE run \
-b dp02 \
-i u/$USER/custom_coadd_window1_test1 \
-o u/$USER/custom_coadd_window1_test1 \
